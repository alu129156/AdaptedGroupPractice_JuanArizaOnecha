...
import com.example.weatherapp_juanarizaonecha.databinding.ActivityCityChatBinding
import com.example.weatherapp_juanarizaonecha.adapter.MessageAdapter
import com.example.weatherapp_juanarizaonecha.chat.Message
...
class CityChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view.chat.etChatUsername.setText(DataUtils.user.name)
        view.chat.etChatEmail.setText(DataUtils.user.email)
        ...
        view.chat.btnChange.setOnClickListener {
            ...
            if (isEditing) {
                ...
                DataUtils.user.name = view.chat.etChatUsername.text.toString()
                DataUtils.user.email = view.chat.etChatEmail.text.toString()
